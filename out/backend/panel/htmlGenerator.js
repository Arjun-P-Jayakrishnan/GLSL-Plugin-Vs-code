...
function getWebviewHTML(context, panel) {
    const htmlPath = vscode.Uri.joinPath(context.extensionUri, "webview-ui", "index.html");
    let html = fs.readFileSync(htmlPath.fsPath, "utf8");
    const scriptPathOnDisk = vscode.Uri.joinPath(context.extensionUri, "out", "frontend", "webview", "index.js");
